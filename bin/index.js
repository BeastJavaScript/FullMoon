...
(function() {
  var Asset, CallableFunction, ChildDirective, CommandLine, CustomDirective, Directive, DirectoryManager, EndForEach, EndIf, FileManager, ForEach, If, Log, MegaFile, NameDirective, NeedDirective, PHPRouteBuilder, ParentDirective, Placeholder, RenderDirective, RenderLine, RepeatDirective, RouteBuilder, SectionDirective, StopDirective, Variable, ViewBuilder, async, fs, mkdirp, os, path,
  ...
  Placeholder = (function() {
    function Placeholder(match, replacement, preview) {
      var _base, _base1;
      this.match = match;
      ...
      if ((_base = this["static"]).regex == null) {
        _base.regex = new RegExp(this.match);
      }
      if ((_base1 = this["static"]).regexR == null) {
        _base1.regexR = new RegExp(this.match, "g");
      }
    }

    Placeholder.prototype.canHandle = function(text) {
      return this["static"].regex.exec(text) !== null;
    };

    Placeholder.prototype.getReplacement = function(text) {
      return text.replace(this["static"].regexR, this.replacement, text);
    };

    Placeholder.prototype.getPreviewReplacement = function(text) {
      return text.replace(this["static"].regexR, this.preview, text);
    };
  ...
  Asset = (function(_super) {
    ...
    function Asset() {
      Asset.__super__.constructor.call(this, "{{ *?asset[*](.*?)[*] *?}}", "<?php echo assets(\"$1\") ?>", "../application/assets/$1");
    }
  ...
  EndForEach = (function(_super) {
    __extends(EndForEach, _super);

    function EndForEach() {
      EndForEach.__super__.constructor.call(this, "@endforeach", "<?php endforeach; ?>", "");
    }
  ...
  ForEach = (function(_super) {
    ...
    function ForEach() {
      ForEach.__super__.constructor.call(this, "@foreach\\((.*)\\)", "<?php foreach$1: ?>", "");
    }
  ...
  EndIf = (function(_super) {
    __extends(EndIf, _super);

    function EndIf() {
      EndIf.__super__.constructor.call(this, "@endif", "<?php endif; ?>", "");
    }
  ...
  If = (function(_super) {
    ...
    function If() {
      If.__super__.constructor.call(this, "@if\\((.+)\\)", "<?php if($1): ?>", "");
    }
  ...
  CallableFunction = (function(_super) {
    __extends(CallableFunction, _super);

    function CallableFunction() {
      CallableFunction.__super__.constructor.call(this, "{{exec\\*(.*)\\* ?([^}]*)}}", "<?php echo $1 ?>", "$2");
    }
  ...
  Variable = (function(_super) {
    ...
    function Variable() {
      Variable.__super__.constructor.call(this, "{{ ?([^@ ]+) ?([^}]*?)}}", "<?php echo $$$1 ?>", "$2");
    }
  ...
  RenderLine = (function() {
    ...
    RenderLine.prototype.buildtools = function() {
      ...
      _ref = [new Asset, new NeedDirective, new ParentDirective, new RepeatDirective, new SectionDirective, new NameDirective, new ChildDirective, new RenderDirective, new StopDirective, new CallableFunction, new Variable, new If, new EndIf, new ForEach, new EndForEach];
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        tool = _ref[_i];
      ...
      while (true) {
        ...
        if (reader.hasNextLine()) {
          ...
          if (!directive) {
            ...
            stop = true;
          } else if (directive instanceof Asset || directive instanceof Variable || directive instanceof CallableFunction || directive instanceof If || directive instanceof EndIf || directive instanceof ForEach || directive instanceof EndForEach) {
  ...
  ViewBuilder = (function() {
    ...
    ViewBuilder.prototype.print = function(line) {
      var parentname, sectionName, t;
      t = this.canHandle(line);
      if (t) {
        if (t instanceof NeedDirective) {
          line = "<?php include('" + (t.getDirective(line).value) + "." + this.ext + "') ?>";
        }
        if (t instanceof RenderDirective || t instanceof RepeatDirective || t instanceof NameDirective) {
          line = "";
          return;
        }
        ...
        if (t instanceof Variable || t instanceof CallableFunction || t instanceof If || t instanceof EndIf || t instanceof ForEach || t instanceof EndForEach || t instanceof Asset) {
          line = t.getReplacement(line);
        }
      }
      return fs.appendFileSync(this.file(), "" + line + os.EOL);
    };
    ...
    ViewBuilder.prototype.buildtools = function() {
      var tool, _i, _len, _ref, _results;
      _ref = [new Asset, new NeedDirective, new ParentDirective, new RepeatDirective, new SectionDirective, new NameDirective, new ChildDirective, new RenderDirective, new StopDirective, new CallableFunction, new Variable, new If, new EndIf];
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        tool = _ref[_i];
        _results.push(this.tools.push(tool));
  ...
  ChildDirective = (function(_super) {
    ...
    function ChildDirective() {
      ChildDirective.__super__.constructor.call(this, "child", "[^ \r\n]+");
    }
  ...
  NameDirective = (function(_super) {
    ...
    function NameDirective() {
      NameDirective.__super__.constructor.call(this, "name", "[^ \r\n]+");
    }
  ...
  CommandLine = (function() {
    ...
    CommandLine.prototype.viewBuild = function() {
      var basedir, config, dm, exclude, match, program, viewbuilder, viewpath;
      dm = new DirectoryManager();
      program = this.program;
      basedir = this.basedir;
      config = this.config;
