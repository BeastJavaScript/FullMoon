...
(function() {
  var Directive, DirectoryManager, NeedDirective, ParentDirective, ParentDirectiveTest, RepeatDirective, RepeatDirectiveTest, SectionDirective, SectionDirectiveTest, TestCase, TestDirective, TestDirectoryManager, TestNeedDirectiveTest, async,
    ...
    TestDirectoryManager.prototype.testReadingFiles = function(dm) {
      return async.series([
        function(callback) {
          ...
          return dm.loadFiles("./", null, "^(node_modules|\\.)", callback);
        }, (function(_this) {
